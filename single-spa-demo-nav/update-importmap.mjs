...
const url = `https://${s3Bucket}.s3-${awsRegion}.amazonaws.com/@${orgName}/single-spa-demo-nav/${commitSha}/${orgName}-single-spa-demo-nav.js`;
  ...
  .get(url, res => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@${orgName}/single-spa-demo-nav`;
