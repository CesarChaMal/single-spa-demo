...
mkdir -p "dist/@${ORG_NAME}/root-config/${GITHUB_SHA}"
mv dist/*.* "dist/@${ORG_NAME}/root-config/${GITHUB_SHA}/"
...
echo "Updating import map to point to new version of @${ORG_NAME}/root-config"
