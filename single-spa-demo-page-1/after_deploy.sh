...
mkdir -p "dist/@${ORG_NAME}/single-spa-demo-page-1/${GITHUB_SHA}"
mv dist/*.* "dist/@${ORG_NAME}/single-spa-demo-page-1/${GITHUB_SHA}/"
...
echo "Updating import map to point to new version of @${ORG_NAME}/single-spa-demo-page-1"
